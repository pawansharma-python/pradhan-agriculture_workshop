...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyQaMBXuI0wywdm3htwJZAvES0SlMa9pXi1tKEN8Y-qubtllDo1nquNHVk5ZzckvNKXAw/exec";
...
async function fetchProducts() {
    if (SCRIPT_URL === "https://script.google.com/macros/s/AKfycbyQaMBXuI0wywdm3htwJZAvES0SlMa9pXi1tKEN8Y-qubtllDo1nquNHVk5ZzckvNKXAw/exec") {
...
async function deleteProduct(id) {
    Swal.fire({ title: 'Delete Machine?', icon: 'warning', showCancelButton: true, confirmButtonColor: '#DD2C00', confirmButtonText: 'Delete' }).then(async (result) => {
        if (result.isConfirmed) {
            if (SCRIPT_URL === "https://script.google.com/macros/s/AKfycbyQaMBXuI0wywdm3htwJZAvES0SlMa9pXi1tKEN8Y-qubtllDo1nquNHVk5ZzckvNKXAw/exec") return;
